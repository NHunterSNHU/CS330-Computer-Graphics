...
private:
	...
	// set the scene lighting values into the shader
	...
	// mesh transformations for the fountain object
	void DrawFountain(float posX, float posY, float posZ);

	// mesh transformations for the bunny object
	void DrawBunny(float posX, float posY, float posZ);

	// mesh transformations for the feeder object
	void DrawFeeder(float posX, float posY, float posZ);

	void DrawStorageBox(float posX, float posY, float posZ);
